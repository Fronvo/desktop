...
import type { CreatePostParams, CreatePostResult } from 'interfaces/socket/account/createPost';
import type {
	DeleteCommunityMessageParams,
	DeleteCommunityMessageResult,
} from 'interfaces/socket/account/deleteCommunityMessage';
import type { DeletePostParams, DeletePostResult } from 'interfaces/socket/account/deletePost';
import type {
...
import type { LoginParams, LoginResult } from 'interfaces/socket/noAccount/login';
import type { LoginTokenParams, LoginTokenResult } from 'interfaces/socket/noAccount/loginToken';
import type { RegisterParams, RegisterResult } from 'interfaces/socket/noAccount/register';
import type {
...
export interface ClientToServerEvents {
	register: ({}: RegisterParams, callback?: ({}: RegisterResult) => void) => void;
	registerVerify: (
		{}: RegisterVerifyParams,
		callback?: ({}: RegisterVerifyResult) => void,
	) => void;
	login: ({}: LoginParams, callback?: ({}: LoginResult) => void) => void;
	loginToken: ({}: LoginTokenParams, callback?: ({}: LoginTokenResult) => void) => void;
	...
	resetPassword: ({}: ResetPasswordParams, callback?: ({}: ResetPasswordResult) => void) => void;
	resetPasswordVerify: (
		{}: ResetPasswordVerifyParams,
	...
	createPost: ({}: CreatePostParams, callback?: ({}: CreatePostResult) => void) => void;
	fetchProfilePosts: (
		{}: FetchProfilePostsParams,
		callback?: ({}: FetchProfilePostsResult) => void,
	) => void;
	deletePost: ({}: DeletePostParams, callback?: ({}: DeletePostResult) => void) => void;
	followProfile: ({}: FollowProfileParams, callback?: ({}: FollowProfileResult) => void) => void;
	unfollowProfile: (
		{}: UnfollowProfileParams,
		callback?: ({}: UnfollowProfileResult) => void,
	) => void;
	findProfiles: ({}: FindProfilesParams, callback?: ({}: FindProfilesResult) => void) => void;
	...
	joinCommunity: ({}: JoinCommunityParams, callback?: ({}: JoinCommunityResult) => void) => void;
	fetchCommunityData: (
		{}: FetchCommunityDataParams,
	...
	fetchCommunityMessages: (callback?: ({}: FetchCommunityMessagesResult) => void) => void;
