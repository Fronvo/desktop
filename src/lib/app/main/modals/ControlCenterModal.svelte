...
<div class="settings-container">
	...
	<div class="data-container">
		<button on:click={() => showModal(ModalTypes.EditProfile)}>Edit Profile</button>
		<button on:click={() => showModal(ModalTypes.CreatePost)}>Create Post</button>
		<button on:click={() => showModal(ModalTypes.FindProfiles)}>Find Profiles</button>
