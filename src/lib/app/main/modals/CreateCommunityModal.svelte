<script lang="ts">
	...
	import { chatRequestAccepted, joinedCommunity } from 'stores/app/communities';
	...
	onMount(() => {
		...
		iconPreview.onerror = () => {
			...
			const attachmentText = document.getElementsByClassName('icon-info')[0];
...
<div class="create-container">
	...
	<div class="data-container">
		...
		<img id="icon-preview" src={$icon ? $icon : ''} alt="Community icon" draggable={false} />
