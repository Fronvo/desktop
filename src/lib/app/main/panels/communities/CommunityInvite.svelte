<script lang="ts">
	...
	import { joinedCommunity, targetCommunity, targetCommunityData } from 'stores/app/communities';
	...
	function formatDate(): string {
		return new Date($targetCommunityData.creationDate).toLocaleDateString(undefined, {
			day: '2-digit',
			month: 'short',
			year: 'numeric',
		});
...
{#if $targetCommunityData}
	<div class="invite-container" in:fade={{ duration: 500, delay: 250 }}>
		...
		<div class="community-container" in:fade={{ duration: 500, delay: 250 }}>
			<img
				id="avatar"
