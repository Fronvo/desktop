<script lang="ts">
	...
	import { accountRegisterTab, accountRegisterVerifyTab } from 'stores/app/account';
	...
	onMount(() => {
		...
		setEnterHandle(emailInput, registerButton), setEnterHandle(passwordInput, registerButton);
	});
...
<Center absolute>
	...
	>
		...
		<input id="password-input" bind:value={password} type="password" maxlength={90} />
