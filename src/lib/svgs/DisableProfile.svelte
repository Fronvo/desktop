<script lang="ts">
	...
	function toggleDisable(): void {
		socket.emit('toggleDisableAccount', { profileId: $userData.profileId }, ({ err }) => {
			if (!err) {
...
>
	<defs>
		<linearGradient id="DISABLE" gradientUnits="userSpaceOnUse" />
		<linearGradient id="disable" x1="47" y1="9.6" x2="1" y2="38.4" href="#DISABLE">
